...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Ago-2025 às 17:44
...
ALTER TABLE `foto`
  ...
  ADD KEY `fk_id_postagem` (`id_postagem`);
...
--
ALTER TABLE `nota`
  ADD CONSTRAINT `nota_ibfk_1` FOREIGN KEY (`id_professor`) REFERENCES `professor` (`id_professor`) ON DELETE CASCADE,
  ADD CONSTRAINT `nota_ibfk_2` FOREIGN KEY (`id_projeto`) REFERENCES `projeto` (`id_projeto`) ON DELETE CASCADE;
...
--
ALTER TABLE `projeto`
  ADD CONSTRAINT `id_ods` FOREIGN KEY (`id_ods`) REFERENCES `ods` (`id_ods`);
COMMIT;
